...
var dimensions = [
  ...
  {
    key: "Population over 65 (%)",
    description: "Population over 65 (%)",
    type: types["Number"]
  },
  {
    key: "Non-white Population",
    description: "Non-white Population")",
    type: types["Number"]
  },
  {
  ...
  {
    key: "No High School Education (%)"",
    description: "No High School Education (%)",
    type: types["Number"]
  },
  {
    key: "Unemployment (%)",
  ...
  }
  {
    ...
    description: "Private Open Space (%)",
    type: types["Number"]
  }
  {
    key: "Impervious Surfaces (%)",
    description: "Impervious Surfaces (%)",
    type: types["Number"]
  }
  {
    key: "Total SVI Flags",
    description: "Total SVI Flags",
    type: types["Number"]
  }
  {
    key: "2016 Canopy Cover (%)",
    description: "2016 Canopy Cover (%)",
    type: types["Number"]
  }
];
